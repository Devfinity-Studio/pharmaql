    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 flex flex-col md:flex-row">
      <aside className="w-full md:w-72 bg-white shadow-[4px_0_24px_rgba(0,0,0,0.02)] border-r border-gray-100 flex flex-col p-6 z-10">
        <div className="mb-10">
          ...
          <div className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">MR Portal</div>
        </div>
        
        <nav className="flex flex-col space-y-3">
          <Link href="/dashboard" className="px-4 py-3 hover:bg-blue-50 hover:text-blue-700 rounded-xl text-gray-600 font-bold transition flex items-center gap-3">
