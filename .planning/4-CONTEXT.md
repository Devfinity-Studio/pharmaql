...
- *Note:* The CSV ingestion parser (Phase 2) may need a slight update to map this if it's provided in future CSVs, but for now, it can default to "Unknown" or be editable by the Admin.
